...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$HOME/data/SynLogic/hard/train.parquet \
    data.val_files=$HOME/data/SynLogic/hard/test.parquet \
    data.train_batch_size=1024 \
    data.max_prompt_length=512 \
    data.max_response_length=1024 \
    data.filter_overlong_prompts=True \
    data.truncation='error' \
    actor_rollout_ref.model.path=/workspace/dujh22_data/djh/models/Qwen2.5-7B-Instruct \
    ...
    trainer.experiment_name='qwen2.5_7b_function_rm_synlogic_hard' \
